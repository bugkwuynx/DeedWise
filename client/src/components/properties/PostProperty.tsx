import { Box, Card, CardContent, Typography, Divider, TextField, Select, MenuItem, Button, CircularProgress } from "@mui/material";
import React, { useState } from "react";
import { NewProperty } from "../../types/Properties";
...
const PostProperty = () => {
    ...
    const handlePostProperty = async () => {
        ...
        const response: Response = await fetch( `${ process.env.REACT_APP_API_URL }/properties`, {
            method: "POST",
                ...
                >
                    ...
                    >
                        ...
                        <TextField
                            ...
                            onChange={(e) => setProperty( { ...property, sqft: parseInt( e.target.value ) } )}
                        />
                        <TextField
                            label="Year Built"
                            variant="outlined"
                            ...
                            onChange={(e) => setProperty( { ...property, yearBuilt: parseInt( e.target.value ) } )}
                        />
                        <TextField
                            label="Property Type"
                            variant="outlined"
